...
var grammar = {
    ...
    {"name": "Noun$macrocall$1", "symbols": ["Noun$macrocall$1$subexpression$1"], "postprocess": g.TAG},
    ...
    {"name": "Verb$macrocall$1", "symbols": ["Verb$macrocall$1$subexpression$1"], "postprocess": g.TAG},
    ...
    {"name": "Adjective$macrocall$1", "symbols": ["Adjective$macrocall$1$subexpression$1"], "postprocess": g.TAG},
    ...
    {"name": "Pronoun$macrocall$1", "symbols": ["Pronoun$macrocall$1$subexpression$1"], "postprocess": g.TAG},
    ...
    {"name": "PN$macrocall$1", "symbols": ["PN$macrocall$1$subexpression$1"], "postprocess": g.TAG},
    ...
    {"name": "Determiner$macrocall$1", "symbols": ["Determiner$macrocall$1$subexpression$1"], "postprocess": g.TAG},
    ...
    {"name": "Preposition$macrocall$1", "symbols": ["Preposition$macrocall$1$subexpression$1"], "postprocess": g.TAG},
    ...
    {"name": "Conjunction$macrocall$1", "symbols": ["Conjunction$macrocall$1$subexpression$1"], "postprocess": g.TAG},
    ...
    {"name": "RelClause$macrocall$1", "symbols": ["RelClause$macrocall$1$subexpression$1"], "postprocess": g.TAG},
